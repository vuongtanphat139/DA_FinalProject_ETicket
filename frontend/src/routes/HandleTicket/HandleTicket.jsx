      ...
      <tr key={ticket.ticket_id}>
        <td className="text-center whitespace-nowrap border border-black">
          <input
            ...
            onChange={(e) =>
              handleInputChangeWithIndex(index, "ticket_type", e.target.value)
            }
          />
        </td>
        <td className="text-center whitespace-nowrap border border-black">
          <input
            ...
            onChange={(e) =>
              handleInputChangeWithIndex(index, "ticket_price", e.target.value)
            }
          />
        </td>
        <td className=" text-center whitespace-nowrap border border-black">
          <input
            ...
            className="text-center whitespace-nowrap w-1/2"
    ...
    <>
      <div class={styles.main}>
        <div class={styles.insidebox}>
            ...
            <tr>
              <td className="text-center px-0 py-0  border border-black">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("ticket_type", e.target.value)
                  }
                />
              </td>
              <td className="text-center px-0 py-0 border border-black">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("ticket_price", e.target.value)
                  }
                />
              </td>
              <td className="text-center px-0 py-0 border border-black">
          ...
          <a href="http://localhost:5173/events/1">
            <button
              className="rounded-full w-[50px] h-[50px] text-center mt-[350px] 
